...
Dim strComputer, uninstString, GUID, DisplayName, Install, softVersion
...
Select Case WinArch
	...
	Case "x86"
		...
		Set Install = objShell.RegRead(HKEY_LOCAL_MACHINE & "\SOFTWARE\Adobe\Acrobat Reader\9.0\Install")
